...
La primera etapa del taller introduce los fundamentos del **desarrollo asistido por IA** en entornos reales: cómo un IDE como Cursor orquesta agentes, compone contexto, expone herramientas externas y puede gobernarse con reglas, skills y hooks. Los laboratorios están pensados para recorrerse en orden: cada uno construye sobre conceptos del anterior (bucle agente → delegación → instrucciones reutilizables → límites de contexto → integraciones MCP → control del runtime → portabilidad entre clientes → amenazas y mitigaciones).
...
### [Laboratorio 3: Prompts y skills](./laboratorios/skills/README.md)
...
### [Laboratorio 4: Ventana de contexto y atención](./laboratorios/context/README.md)
...
### [Laboratorio 5: MCP (Model Context Protocol)](./laboratorios/mcp/README.md)
...
### [Laboratorio 6: Hooks](./laboratorios/hooks/README.md)
...
### [Laboratorio 7: Compatibilidad de configuración entre agentes](./laboratorios/config/README.md)
